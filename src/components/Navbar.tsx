      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 md:px-6">
        ...
        <div className="hidden items-center gap-1 md:flex">
          {links.map((l) => (
            <Link
              ...
              activeProps={{ className: "rounded-md px-3 py-1.5 text-sm text-[color:var(--cyan-neon)] bg-[#161b22]" }}
        ...
        <div className="hidden items-center gap-2 rounded-full border border-[#30363d] bg-[#161b22] p-1 md:flex">
          <Link
            ...
            activeProps={{ className: "rounded-full px-3 py-1 text-xs font-medium bg-[color:var(--red-neon)]/15 text-[color:var(--red-neon)]" }}
          >
            ⚠ Vulnerable
          </Link>
          <Link
            ...
            activeProps={{ className: "rounded-full px-3 py-1 text-xs font-medium bg-[color:var(--green-neon)]/15 text-[color:var(--green-neon)]" }}
          >
            ✓ Secure
          </Link>
        </div>
      ...
      <div className="flex gap-1 overflow-x-auto border-t border-[#30363d] px-3 py-2 md:hidden">
        {links.map((l) => (
          <Link
            ...
            activeProps={{ className: "shrink-0 rounded-md px-3 py-1 text-xs text-[color:var(--cyan-neon)] bg-[#161b22]" }}
            activeOptions={{ exact: l.to === "/" }}
          >
            {l.label}
          </Link>
